...
const INSTRUCTION_OVERRIDE: Signature[] = [
  ...
  sig(
    "io.cancel_task", "instruction_override", "medium", 0.50,
  ...
  sig(
    "io.reset_context", "instruction_override", "medium", 0.50,
...
const EXFILTRATION: Signature[] = [
  ...
  sig(
    "exfil.markdown_link_data", "exfiltration", "high", 0.70,
...
const JAILBREAK: Signature[] = [
  ...
  sig(
    "jb.unlock_mode", "jailbreak", "high", 0.62,
  ...
  sig(
    "jb.hypothetical", "jailbreak", "medium", 0.50,
...
const TOOL_INJECTION: Signature[] = [
  ...
  sig(
    "tool.shell_exec", "tool_injection", "high", 0.60,
